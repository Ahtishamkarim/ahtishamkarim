...
I'm a Software Engineer with hands-on experience building scalable web applications end-to-end — from responsive front-end interfaces to back-end APIs, databases, and deployment. I enjoy solving real problems, working with international clients, and shipping products that people actually use. Strong problem solver, fast learner, and team player focused on meeting goals and deadlines.
